...
export const api = {
  ...
  getResumes: async () => {
    ...
    return getStorage('kronos_resumes', [
      { role_name: 'Software Engineer', file_name: 'Software_Engineer_Resume.pdf', resume_text: 'Software Engineer proficient in React, Node.js, Python, SQL, and system design.', ats_score: 94, grammar_score: 96, formatting_score: 92, keyword_score: 95, missing_skills: 'GraphQL Telemetry, Kubernetes', suggestions: 'Add quantifiable achievements for microservice latency optimization.' },
